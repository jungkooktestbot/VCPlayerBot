...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Meme Channel', url='https://t.me/TeenagerMemesHindi'),
            InlineKeyboardButton('🧩 Source', url='https://youtu.be/dQw4w9WgXcQ')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://youtu.be/dQw4w9WgXcQ'),
            InlineKeyboardButton('⚙️ Meme Channel', url='https://t.me/TeenagerMemesHindi'),     
        ],
        [
